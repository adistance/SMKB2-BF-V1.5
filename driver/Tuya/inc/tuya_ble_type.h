...
typedef enum {
    ...
    TUYA_BLE_CB_EVT_NETWORK_INFO,   //70
    ...
    TUYA_BLE_CB_EVT_DP_DATA_WITH_FLAG_AND_TIME_REPORT_RESPONSE,  //80
	...
	TUYA_BLE_CB_EVT_SCENE_REQ_RESPONSE,					// 90 received request scene data or control app response 			
