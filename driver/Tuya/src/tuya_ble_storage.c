...
//清除掉绑定的信息
uint8_t tuya_ble_storage_reset(void)
{
	TUYA_BLE_LOG_DEBUG("tuya_ble_storage_reset");

	memset((uint8_t *)&tuya_ble_current_para.sys_settings, 0, sizeof(tuya_ble_sys_settings_t));
	//memset((uint8_t *)&tuya_ble_current_para.auth_settings, 0, sizeof(tuya_ble_auth_settings_t));
