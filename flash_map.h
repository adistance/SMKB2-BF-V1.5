...
example:
	...
	3) Factory Code:                                     0K (0x00802000)
	4) OTA Bank0:                                    272K (0x00802000)
		a) OTA Header                    4K (0x00802000)
		b) Secure boot loader            4K (0x0080D000)
		c) Patch code                   40K (0x00803000)
		d) Upperstack  Code            112K (0x0080E000)
		e) APP code                    112K (0x0082A000)
		f) APP data1                     0K (0x00846000)
	...
	5) OTA Bank1:                                      0K (0x00850000)
		...
		j) APP data5                     0K (0x00000000)
		k) APP data6                     0K (0x00000000)
	6) FTL:                                           16K (0x00846000)
	7) OTA Tmp:                                      132K (0x0084C000)
	8) APP Defined Section:                            0K (0x00880000)
*/
...
#define FACTORY_CODE_ADDR               0x00802000
#define FACTORY_CODE_SIZE               0x00000000  //0K Bytes
#define OTA_BANK0_ADDR                  0x00802000
#define OTA_BANK0_SIZE                  0x00044000  //272K Bytes
#define OTA_BANK1_ADDR                  0x00850000
#define OTA_BANK1_SIZE                  0x00000000  //0K Bytes
#define FTL_ADDR                        0x00846000
#define FTL_SIZE                        0x00004000  //16K Bytes
#define OTA_TMP_ADDR                    0x0084C000
#define OTA_TMP_SIZE                    0x00021000  //132K Bytes
...
#define BANK0_UPPERSTACK_SIZE           0x0001C000  //112K Bytes
#define BANK0_APP_ADDR                  0x0082A000
#define BANK0_APP_SIZE                  0x0001C000  //112K Bytes
#define BANK0_APP_DATA1_ADDR            0x00846000
