...
#define UPPERSTACK_GLOBAL_SIZE         (4 * 1024)                                   //upperstack的大小

/** @brief data ram size for app global variables and code, could be changed */
#define APP_GLOBAL_SIZE                (46 * 1024)     //(57 * 1024)                                  //APP的大小
...
#define HEAP_DATA_ON_SIZE              (25 * 1024) //(115 * 1024 - APP_GLOBAL_SIZE - UPPERSTACK_GLOBAL_SIZE)
